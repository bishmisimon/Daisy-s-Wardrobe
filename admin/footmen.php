 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="Blaiser.php"</script>';  
           }  
      }  
      else  
      {  
...
<div class="col-3">
<h2 class="headline">Footwear For Men/h2> 
</div>
               ...
               $query = "SELECT * FROM store WHERE subCategory='Footwear for men'";
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="Blaiser.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div class ="box">  
