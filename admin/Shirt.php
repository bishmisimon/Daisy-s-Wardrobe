...
<h2 class="headline">Blaiser Collection</h2> 
               ...
               $query = "SELECT * FROM store WHERE subCategory='Shirt'";
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="Shirt.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div class ="box">  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="Shirt.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
