 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="Frock.php"</script>';  
           }  
      }  
      else  
      {  
...
<div class="col-3">
<h2 class="headline">Frock Collection</h2> 
</div>
               ...
               $query = "SELECT * FROM store WHERE subCategory='frock'";
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="Frock.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div class ="box">  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="Frock.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
