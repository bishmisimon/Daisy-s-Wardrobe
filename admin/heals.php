...
<div class="col-3">
<h2 class="headline">Heals Collection/h2> 
</div>
               ...
               $query = "SELECT * FROM store WHERE subCategory='heals'";
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="heals.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div class ="box">  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="heals.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
