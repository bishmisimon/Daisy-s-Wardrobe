...
<h2 class="headline">Blaiser Collection</h2> 
               ...
               $query = "SELECT * FROM store WHERE subCategory='T-shirt'";
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="T-shirt.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div class ="box">  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="T-shirt.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
