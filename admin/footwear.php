 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="footwear.php"</script>';  
           }  
      }  
      else  
      {  
...
<video autoplay muted loop id="myVideo">
  <source src="../admin/Videos/shoes.mp4" type="video/mp4">
 

    
</video>
<div class="col-3">
<h2 class="headline">Footwear collection/h2> 
</div>
               ...
               $query = "SELECT * FROM store WHERE category='Footwear for Men'";
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="footwear.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div class ="box">  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="Blaiser.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
