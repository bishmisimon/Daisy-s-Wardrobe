 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="Boots.php"</script>';  
           }  
      }  
      else  
      {  
...
<div class="col-3">
<h2 class="headline">Boots Collection</h2> 
</div>
               ...
               $query = "SELECT * FROM store WHERE subCategory='boots'";
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="Boots.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div class ="box">  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="Boots.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
