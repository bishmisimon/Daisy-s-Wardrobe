...
<div class="col-3">
<h2 class="headline">Lehenga Collection</h2> 
</div>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-6">
      <input  class = "topnav"type="text" class="form-control" id="search"  placeholder="Search">
  ...
  $(document).ready(function(){
    ...
    <div class="col-sm-3">
               ...
               $query = "SELECT * FROM store WHERE subCategory='Lehenga'";
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="Lehenga.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div class ="box">  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="Lehenga.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
