 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="footwomen.php"</script>';  
           }  
      }  
      else  
      {  
...
<div class="col-3">
<h2 class="headline">Women's Footwear Collection</h2> 
</div>
               ...
               $query = "SELECT * FROM store WHERE category='Footwear for Women'";
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="footwomen.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div class ="box">  
